        ...
        <form action="{{ route('responden.store' ) }}" method="post" enctype="multipart/form-data">
            @csrf
                <div class="grid gap-4 mb-3 sm:grid-cols-2 sm:gap-6 sm:mb-3">
                    ...
                    <div class="w-full">
                        <label for="usia" class="block mb-2 text-sm font-medium text-gray-900">Usia Responden</label>
                        <input type="number" name="usia" id="usia" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Input Usia Responden..." required>
                    </div>
                    <div class="w-full">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="pekerjaan" id="pekerjaan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Input Pekerjaan Responden..." required>
                    </div>
                </div>
                <div class="w-full">
