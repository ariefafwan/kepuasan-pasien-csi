...
@endif
    ...
    <div class="p-4 bg-white rounded-lg">
        ...
        @include('admin.responden.create')
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <h2 class="text-2xl font-bold mb-4">Data Responden</h2>
            <table id="example" class="table-auto w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">{{ $data->nama_wali }}</td>
                        ...
                        <td class="border px-4 py-2">{{ $data->pekerjaan }}</td>
                        <td class="border px-4 py-2">
                            <div class="inline-flex rounded-md shadow-sm" role="group">
                                ...
                                <form id="data-delete-form-{{$data->id}}"
                                    action="{{ route('responden.destroy', $data->id) }}" method="POST"
                                    style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
